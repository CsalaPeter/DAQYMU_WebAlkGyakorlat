...
public class EchoServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<body><h2>Recorded data</h2>");
            ...
            if (age == null) {
                ...
                out.println("<p>Age: &lt; 1 years old</p>");
            } else if (age.equals("99")) {
                out.println("<p>Age: 1 - 99 </p>");
            } else {
            ...
            if (languages == null || languages.length == 0) {
                out.println("<p>Language: NONE</p>");
            } else {
                out.println("<p>Language: ");
            ...
            out.println("<p>Requested parameter names: ");
